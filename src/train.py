...
#             model.load_state_dict(checkpoint['model_state_dict'])
        ...
        valid_dataset = UkiyoeDataset(datatype='train', img_ids=valid_ids_new, transforms = get_validation_augmentation(opts.img_size), preprocessing=get_preprocessing(None))
